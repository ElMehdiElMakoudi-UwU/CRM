...
SECRET_KEY = 'django-insecure-+z+k81_92*!%3s(7c_9nm-yl$n@sh)ds@@tny!2vlfhf^)sy($'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['146.59.230.241', 'localhost', '127.0.0.1']
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'gestion_commerciale', 'templates'), ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
